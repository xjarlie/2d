...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib_global__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/global */ \"./src/lib/global.ts\");\n/* harmony import */ var _lib_keyMap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/keyMap */ \"./src/lib/keyMap.ts\");\n/* harmony import */ var _tick__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tick */ \"./src/tick.ts\");\n/* harmony import */ var _Player__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Player */ \"./src/Player.ts\");\n/* harmony import */ var _Vector__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Vector */ \"./src/Vector.ts\");\n/* harmony import */ var _Ground__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Ground */ \"./src/Ground.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\nfunction main() {\r\n    var canvas = document.getElementById('canvas');\r\n    var ctx = canvas.getContext(\"2d\");\r\n    _lib_global__WEBPACK_IMPORTED_MODULE_0__[\"default\"].ctx = ctx;\r\n    _lib_global__WEBPACK_IMPORTED_MODULE_0__[\"default\"].gravity = 9.81 * 200;\r\n    // global.scale = 0.1;\r\n    _lib_global__WEBPACK_IMPORTED_MODULE_0__[\"default\"].airConstant = 1;\r\n    var player = new _Player__WEBPACK_IMPORTED_MODULE_3__[\"default\"](200, 200);\r\n    player.gravity = false;\r\n    player.add();\r\n    var ground = new _Ground__WEBPACK_IMPORTED_MODULE_5__[\"default\"](300, 400, 300, 25);\r\n    ground.add();\r\n    requestAnimationFrame(_tick__WEBPACK_IMPORTED_MODULE_2__.tick);\r\n    window.addEventListener(\"keydown\", function (key) { (0,_lib_keyMap__WEBPACK_IMPORTED_MODULE_1__.keyListener)(key, 'down'); });\r\n    window.addEventListener(\"keyup\", function (key) { (0,_lib_keyMap__WEBPACK_IMPORTED_MODULE_1__.keyListener)(key, 'up'); });\r\n    // vector testing\r\n    var a = new _Vector__WEBPACK_IMPORTED_MODULE_4__.Vector(0.1, 1);\r\n    var b = new _Vector__WEBPACK_IMPORTED_MODULE_4__.Vector(2, 0.2);\r\n    console.warn(_Vector__WEBPACK_IMPORTED_MODULE_4__.Vector.divide(a, b, 10));\r\n}\r\nwindow.onload = main;\r\n\n\n//# sourceURL=webpack://canvassy/./src/index.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"tick\": () => (/* binding */ tick),\n/* harmony export */   \"ticks\": () => (/* binding */ ticks)\n/* harmony export */ });\n/* harmony import */ var _lib_collisions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/collisions */ \"./src/lib/collisions.ts\");\n/* harmony import */ var _lib_global__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/global */ \"./src/lib/global.ts\");\nvar __spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {\r\n    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {\r\n        if (ar || !(i in from)) {\r\n            if (!ar) ar = Array.prototype.slice.call(from, 0, i);\r\n            ar[i] = from[i];\r\n        }\r\n    }\r\n    return to.concat(ar || Array.prototype.slice.call(from));\r\n};\r\n\r\n\r\nvar ticks = 0;\r\nvar lastTimestamp = 0;\r\n_lib_global__WEBPACK_IMPORTED_MODULE_1__[\"default\"].tps = 0;\r\nfunction tick(timestamp) {\r\n    var deltaTime = timestamp - lastTimestamp;\r\n    _lib_global__WEBPACK_IMPORTED_MODULE_1__[\"default\"].tps = 1 / (deltaTime / 1000);\r\n    //console.info('TPS: ', global.tps);\r\n    (0,_lib_collisions__WEBPACK_IMPORTED_MODULE_0__.handleCollisions)();\r\n    _lib_global__WEBPACK_IMPORTED_MODULE_1__[\"default\"].ctx.clearRect(0, 0, _lib_global__WEBPACK_IMPORTED_MODULE_1__[\"default\"].ctx.canvas.width, _lib_global__WEBPACK_IMPORTED_MODULE_1__[\"default\"].ctx.canvas.height);\r\n    var entities = __spreadArray([], _lib_global__WEBPACK_IMPORTED_MODULE_1__[\"default\"].entities, true);\r\n    //console.log('TICK RUNNING', ticks);\r\n    for (var _i = 0, entities_1 = entities; _i < entities_1.length; _i++) {\r\n        var o = entities_1[_i];\r\n        if (ticks > 5)\r\n            o.tick(deltaTime);\r\n        o.draw();\r\n    }\r\n    lastTimestamp = timestamp;\r\n    ticks++;\r\n    requestAnimationFrame(tick);\r\n}\r\n\r\n\n\n//# sourceURL=webpack://canvassy/./src/tick.ts?");
